...
// begin double-checking of some of the settings in config.inc.php //
  ...
  if(strlen($color1) > 7) {
	...
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>color1</b> is not a valid color.</td></tr>\n";
	echo "            </table>\n";
	$evil = "1";
	echo "            <br />\n";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>color2</b> is not a valid color.</td></tr>\n";
	echo "            </table>\n";
	$evil = "1";
	echo "            <br />\n";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>logo</b> is longer than the allowed 200 characters.</td></tr>\n";
	echo "            </table>\n";
	$evil = "1";
	echo "            <br />\n";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>refresh</b> is longer than the allowed 10 characters.</td></tr>\n";
	echo "            </table>\n";
	$evil = "1";
	echo "            <br />\n";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>email</b> is longer than the allowed 100 characters.</td></tr>\n";
	echo "            </table>\n";
	$evil = "1";
	echo "            <br />\n";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>date_link</b> is longer than the allowed 100 characters.</td></tr>\n";
	echo "            </table>\n";
	$evil = "1";
	echo "            <br />\n";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>app_name</b> is longer than the allowed 100 characters.</td></tr>\n";
	echo "            </table>\n";
	$evil = "1";
	echo "            <br />\n";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>app_version</b> is longer than the allowed 100 characters.</td></tr>\n";
	echo "            </table>\n";
	$evil = "1";
	echo "            <br />\n";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>metar</b> is not a valid metar.</td></tr>\n";
	echo "            </table>\n";
	$evil = "1";
	echo "            <br />\n";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>city</b> is longer than the allowed 100 characters.</td></tr>\n";
	echo "            </table>\n";
	$evil = "1";
	echo "            <br />\n";
	...
	if((empty($refresh)) || ($refresh != 'none')) {
	  echo "            <table class='table'>\n";
	  echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>refresh</b> should be an integer (other than zero) or set to \"none\".</td></tr>\n";
	  echo "            </table>\n";
	  $evil = "1";
	  echo "            <br />\n";
	}
	...
	if(isset($evil_link)) {
	  echo "            <table class='table'>\n";
	  echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                          <td>One of the <b>links</b> is longer than the allowed 555 characters.</td></tr>\n";
	  echo "            </table>\n";
	  echo "            <br />\n";
	} elseif(isset($evil_display_link)) {
	  echo "            <table class='table'>\n";
	  echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                      <td>One of the <b>display_links</b> is longer than the allowed 100 characters.</td></tr>\n";
	  echo "            </table>\n";
	  echo "            <br />\n";
	} elseif(isset($evil_allowed_network)) {
	  echo "            <table class='table'>\n";
	  echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                      <td>One of the <b>allowed_networks</b> is longer than the allowed 21 characters.</td></tr>\n";
	  echo "            </table>\n";
	  echo "            <br />\n";
	  ...
	  echo "            <table class='table'>\n";
	  echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                        <td><b>report_start_time</b> is not a valid time.</td></tr>\n";
	  echo "            </table>\n";
	  echo "            <br />\n";
	  ...
	  echo "            <table class='table'>\n";
	  echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                        <td><b>report_end_time</b> is not a valid time.</td></tr>\n";
	  echo "            </table>\n";
	  echo "            <br />\n";
...
// end double-checking of some of the settings in config.inc.php
  ...
  echo "              <tr><td colspan=3>Listed below are the
  ...
  echo "              <tr><td colspan=3>Choose the way dates and times are to be
  ...
  echo "              <tr><td height=25 valign=bottom colspan=3 class=table_rows width=10% align=left style='padding-left:4px;'><u>Date
                      Format:</u></td></tr>\n";
  echo "              <tr><td width=100% colspan=3><table class='table'>\n";
  ...
  echo "              <tr><td colspan=3>Choose the way the reports are
  ...
  if(strtolower($user_or_display) == "user") {
	echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"user_or_display\"
                      value=\"1\" checked />&nbsp;Job<input type=\"radio\" name=\"user_or_display\" value=\"0\" />&nbsp;Display</td>\n";
  } elseif(strtolower($user_or_display) == "display") {
	echo "                  <td bgcolor='$row_color' class=table_rows width=10% align=left valign=top><input type=\"radio\" name=\"user_or_display\"
                      value=\"1\" />&nbsp;Job<input type=\"radio\" name=\"user_or_display\" value=\"0\" checked />&nbsp;Display</td>\n";
  } else {
	echo "                  <td bgcolor='$row_color' class=table_rows_red width=10% align=left valign=top><b>\"Job\" or \"Display\" has not been chosen in
                      config.inc.php</b></td>\n";
  ...
  for($x = 0; $x < count($links); $x++) {
	...
	if(empty($links[$x])) {
	  echo "                      <input type=\"text\" size=\"30\" maxlength=\"555\" name=\"links[$x]\" />\n";
	} else {
	  echo "                      <input type=\"text\" size=\"30\" maxlength=\"555\" name=\"links[$x]\" value=\"$links[$x]\" />\n";
	}
  }
  if(count($links) < '10') {
...
// begin post validation //
  ...
  if($post_office_name != 'all') {
	...
	if(!isset($officename)) {
	  echo "Dept name is not in the database.\n";
	  exit;
	}
  }
  ...
  if(($post_use_passwd != '0') && ($post_use_passwd != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>use_passwd</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_use_reports_password != '0') && ($post_use_reports_password != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>use_reports_password</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_restrict_ips != '0') && ($post_restrict_ips != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>restrict_ips</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_disable_sysedit != '0') && ($post_disable_sysedit != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>disable_sysedit</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_user_or_display != '0') && ($post_user_or_display != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>user_or_display</b> does not equal \"user\" or \"display\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_display_ip != '0') && ($post_display_ip != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>display_ip</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_ip_logging != '0') && ($post_ip_logging != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>ip_logging</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_export_csv != '0') && ($post_export_csv != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>export_csv</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>Date Format</b> is not a valid date format.</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>Time Format</b> is not a valid time format.</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>Round a Jobs Time</b> is not a valid option.</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_use_client_tz != '0') && ($post_use_client_tz != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>use_client_tz</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_use_server_tz != '0') && ($post_use_server_tz != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>use_server_tz</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_use_server_tz == '1') && ($post_use_client_tz == '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>use_server_tz</b> and <b>use_client_tz</b> cannot both be set to  \"yes\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>display_current_users</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_show_display_name != '0') && ($post_show_display_name != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>show_display_name</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_display_office_name != '0') && ($post_display_office_name != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>display_office_name</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_display_group_name != '0') && ($post_display_group_name != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>display_group_name</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_paginate != '0') && ($post_paginate != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>paginate</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_show_details != '0') && ($post_show_details != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>show_display</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_username_dropdown_only != '0') && ($post_username_dropdown_only != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>username_dropdown_only</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
  } elseif(($post_display_weather != '0') && ($post_display_weather != '1')) {
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td><b>display_weather</b> does not equal \"yes\" or \"no\".</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td>The path to your <b>logo</b> is longer than the allowed 200 characters.</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
	...
	echo "            <table class='table'>\n";
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/cancel.png' /></td>
                  <td>Only alphanumeric characters, underscores, periods, and hyphens are allowed when creating an Email
                      Address.</td></tr>\n";
	echo "            </table>\n";
	$evil_post = "1";
...
/* Show a Display Name instead of a Jobname for each user on the main page.
   Default is "no". */
...
/* NOTE : THIS HAS BEEN EDITED TO CORRECTLY ROUND THE *TIMESTAMPS* punches instead of total hours
 * (i.e. when a user punches in/out at 7:04 am it will round that to 7:00 am.
 *		  when a user punches in/out at 7:10 am it will round that to 7:15 am )
 * This is per Labor Laws -- see reference "Rounding Hours Worked" here:
...
/* Choose whether to auto-deduct time for lunch, what hours, and how many worked hours trigger auto-deduct.  If a punch for Lunch is recorded, this will be ignored. (i.e. set trigger at 6 hours, and if no Lunch is recorded, it will auto deduct 0.5 hrs for lunch. Set hours to "0" to disable. */

$lunch_hours = "0.5";		// in hours
$lunch_auto_deduct = "6";	// in hours
...
// end writing the new config.inc.php file //
	...
	echo "              <tr><td width=20 align=center height=25 class=table_rows><img src='../images/icons/accept.png' /></td>
                  <td>&nbsp;System Settings updated successfully.</td></tr>\n";
	echo "            </table>\n";
	echo "            <br />\n";
