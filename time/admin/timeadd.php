...
echo "              <tr><td>Time:</td><td colspan=2 width=80%
...
if (($timefmt == "G:i") || ($timefmt == "H:i")) {
  ...
  $tmp_timefmt_24hr = '0';
  $tmp_timefmt_24hr_text = '12 hr format = HH:MM AM/PM';
  $tmp_timefmt_size = '8';
}
...
//if (($timefmt_24hr_text !== '24 hr format') && ($timefmt_24hr_text !== '12 hr format = HH:MM AM/PM')) {exit;}
...
echo "              <tr><td>Date:</td><td colspan=2 width=80%
                      style='color:red;font-family:Tahoma;;padding-left:20px;'><input type='text'
...
echo "              <tr><td>Date:</td><td align=left class=table_rows
colspan=2 width=80% style='padding-left:20px;'>$post_date</td></tr>\n";
echo "              <tr><td>Time:</td><td align=left class=table_rows
colspan=2 width=80% style='padding-left:20px;'>$post_time</td></tr>\n";
echo "              <tr><td>Status:</td><td align=left class=table_rows colspan=2
width=80% style='color:$color;padding-left:20px;'>$post_statusname</td></tr>\n";
echo "              <tr><td>Notes:</td><td align=left class=table_rows
