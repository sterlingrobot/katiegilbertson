...
//echo "	</pre>";
//echo "</div>";
$user_functions = array('chngpassword.php', 'useradmin.php', 'usercreate.php', 'useredit.php', 'usersearch.php');
...
if ($logo != "none") echo "<a class='col-sm-2 col-xs-12' href='../index.php' ><img border=0 src='../$logo'></a>";
...
if ($date_link == "none") {
	...
	echo "<h3 id='date' class='col-sm-3 col-xs-12 text-primary text-right' style='margin-top: 8px;'>$todaydate</h3>\n";
