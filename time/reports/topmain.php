...
if ($logo != "none") echo "<a class='col-sm-1 col-xs-12 text-center' href='../index.php'><img border=0 src='../$logo'></a>";
...
if ($date_link == "none") {
	...
	echo "<h3 id='date' class='col-sm-4 col-xs-12 text-primary text-right' style='margin-top: 8px;'>$todaydate</h3>\n";
...
//	    $off = ($x === 0)? 'col-sm-offset-1' : '';
        echo "        <div class='col-sm-2 col-xs-6 $off'><a class='btn btn-block btn-info calendar' href='$links[$x]' target='_blank' ><span class='glyphicon glyphicon-calendar'></span> $display_links[$x]</a></div>";
    }

}
// HOME  |  REPORTS  |   ADMIN
echo "	  <div class='col-sm-1 col-xs-4'><a class='btn btn-default btn-block' href='../index.php'><span class='glyphicon glyphicon-home'></span></a></div>\n";
...
elseif ($use_reports_password == "no") {
    echo "    <div class='col-sm-1 col-xs-4'><a class='btn btn-default btn-block report' href='index.php'><span class='glyphicon glyphicon-list-alt'></span></a></div>\n";
}
